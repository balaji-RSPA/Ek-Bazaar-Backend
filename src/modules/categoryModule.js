...
module.exports.getAllCategories = (query) => new Promise((resolve, reject) => {
  ...
  ParentCategory.find({
    _id: { $in: ["5f9a60b98420b75666d810d6", "5f9a60b98420b75666d810d8", "5f9a60b98420b75666d810e2", "5f9a60b98420b75666d810e8"] }
  })
    .populate({
    ...
    .then((doc) => {
      console.log(doc, 'hararararahsdjasfgjhdsghfskdsjirfhsjdnfjsdkfhksdl.fnhkjdfhljkdnjghdlfjkgnjkdfhjgndkjgjdgk')
      resolve(doc);
    })
    .catch(reject);
});
