...
// Parent Category
module.exports.addParentCategories = (data) => new Promise((resolve, reject) => {
...
module.exports.addSecondaryCategories = (data) => new Promise((resolve, reject) => {
...
module.exports.addSecondaryCategory = (data) => new Promise((resolve, reject) => {

    SecondaryCategory.create(data).then((doc) => {
        resolve(doc)
    }).catch(reject)

})

module.exports.getSecondaryCategory = (id) => new Promise((resolve, reject) => {

    SecondaryCategory.findById(id).then((doc) => {
        resolve(doc)
    }).catch(reject)

})

exports.updateSecondaryCategory = (id, newData) => new Promise((resolve, reject) => {

  SecondaryCategory.findByIdAndUpdate(id, {
    $set: newData
  }, {
    new: true
  }).then((doc) => {
...
module.exports.addProductCategories = (data) => new Promise((resolve, reject) => {
...
module.exports.addProductCategory = (data) => new Promise((resolve, reject) => {

    Products.create(data).then((doc) => {
        resolve(doc)
    }).catch(reject)

})

module.exports.getProductCategory = (id) => new Promise((resolve, reject) => {

    Products.findById(id).then((doc) => {
        resolve(doc)
    }).catch(reject)

})

exports.updateProductCategory = (id, newData) => new Promise((resolve, reject) => {
