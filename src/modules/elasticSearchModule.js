...
exports.getSuggestions = (query, range, product, aggs) => new Promise((resolve, reject) => {
  ...
  const searchQuery = {
    index: process.env.NODE_ENV === "production" ? "tradedb.suggestions" : "newtradedb.suggestions",
    body,
  };
  esClient
    .search(searchQuery)
...
exports.getAllCitiesElastic = (query) => new Promise((resolve, reject) => {
  ...
  const searchQuery = {
    index: process.env.NODE_ENV === "production" ? "tradedb.cities" : "newtradedb.cities",
    body,
    from: 0,
    size: 500
  };
...
exports.getAllStatesElastic = (query) => new Promise((resolve, reject) => {
  ...
  const searchQuery = {
    index: process.env.NODE_ENV === "production" ? "tradedb.states" : "newtradedb.states",
    body,
    from: 0,
    size: 500
  };
...
exports.getAllCountriesElastic = query => new Promise((resolve, reject) => {
  ...
  const searchQuery = {
    index: process.env.NODE_ENV === "production" ? "tradedb.countries" : "newtradedb.countries",
    body,
    from: 0,
    size: 500
  };
