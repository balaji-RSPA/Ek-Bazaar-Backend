...
const ssoUrl = global.environment === "production" ? "" : global.environment === "staging" ? "" : "http://localhost:3010/simplesso/login"
...
exports.login = async (req, res) => {
  try {
    ...
    const response = await axios.post(ssoUrl, { mobile, password, ipAddress, serviceURL, userType }, { params: { serviceURL } })
    console.log("🚀 ~ file: authController.js ~ line 39 ~ exports.login= ~ response", response)
