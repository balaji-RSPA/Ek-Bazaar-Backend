...
module.exports.partialRegistred = (params) => ({messagePartial:`Dear ${params.name} , Please complete your registration in-order to receive business enquiries from buyers. ${signInLink} Ekbazaar.com`,templateId:'1707161761052033746'})